...
[assembly: MelonInfo(typeof(Mod), "BTD6 EOS Bypasser", "1.0.9", "GrahamKracker")]
...
namespace BTD6EOSBypasser
{
	...
	public class Mod : MelonMod
	{
		...
		{
			Button storeBtn = __instance.storeBtn;
			...
			storeBtn.onClick.AddListener(new Action(() =>
			{
		...
		[HarmonyPostfix]
		public static void RemoveHeroBundles(HeroUpgradeDetails __instance) => Object.Destroy(__instance.heroBundleBtn.transform.parent.gameObject);
		...
		[HarmonyPostfix]
		public static void DisableBuyInstasButton(InstaTowerScreen __instance) => Object.Destroy(__instance.buyInstasBtn.gameObject);

		[HarmonyPatch(typeof(KnowledgeMain), nameof(KnowledgeMain.Open))]
		[HarmonyPostfix]
		public static void DisableUnlockMKEarlyButton(KnowledgeMain __instance) => Object.Destroy(__instance.storeBanner);
